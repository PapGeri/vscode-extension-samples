...
import { P4grammarListener } from "./P4grammarListener";
import { P4grammarVisitor } from "./P4grammarVisitor";


export class P4grammarParser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(P4grammarParser._LITERAL_NAMES, P4grammarParser._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return P4grammarParser.VOCABULARY;
	}
	// tslint:enable:no-trailing-whitespace

	// @Override
	public get grammarFileName(): string { return "P4grammar.g4"; }
	...
	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(P4grammarParser._ATN, this);
	}
	// @RuleVersion(0)
	public start(): StartContext {
		let _localctx: StartContext = new StartContext(this._ctx, this.state);
		this.enterRule(_localctx, 0, P4grammarParser.RULE_start);
		try {
	...
	public program(): ProgramContext {
		...
		this.enterRule(_localctx, 2, P4grammarParser.RULE_program);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 250;
	...
	public input(_p?: number): InputContext {
		...
		this.enterRecursionRule(_localctx, 4, P4grammarParser.RULE_input, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_input);
						this.state = 253;
					...
					case 2:
						...
						this.state = 256;
						this.match(P4grammarParser.SEMICOLON);
						}
						break;
					}
					}
	...
	public declaration(): DeclarationContext {
		...
		this.enterRule(_localctx, 6, P4grammarParser.RULE_declaration);
		try {
			this.state = 273;
			this._errHandler.sync(this);
	...
	public preprocessorLine(): PreprocessorLineContext {
		...
		this.enterRule(_localctx, 8, P4grammarParser.RULE_preprocessorLine);
		try {
			this.state = 291;
			this._errHandler.sync(this);
			...
			case 1:
				...
				{
				this.state = 275;
				this.match(P4grammarParser.PREPROC_INCLUDE);
				this.state = 276;
			...
			case 2:
				...
				{
				this.state = 277;
				this.match(P4grammarParser.PREPROC_DEFINE);
				}
				break;
			...
			case 4:
				...
				{
				this.state = 282;
				this.match(P4grammarParser.PREPROC_UNDEF);
				}
				break;
			...
			case 5:
				...
				{
				this.state = 283;
				this.match(P4grammarParser.PREPROC_IFDEF);
				}
				break;
			...
			case 6:
				...
				{
				this.state = 284;
				this.match(P4grammarParser.PREPROC_IFNDEF);
				}
				break;
			...
			case 7:
				...
				{
				this.state = 285;
				this.match(P4grammarParser.PREPROC_IF);
				this.state = 286;
				this.expression(0);
				}
				break;
			...
			case 8:
				...
				{
				this.state = 287;
				this.match(P4grammarParser.PREPROC_ELSEIF);
				}
				break;
			...
			case 9:
				...
				{
				this.state = 288;
				this.match(P4grammarParser.PREPROC_ELSE);
				}
				break;
			...
			case 10:
				...
				{
				this.state = 289;
				this.match(P4grammarParser.PREPROC_ENDIF);
				}
				break;
			...
			case 11:
				...
				{
				this.state = 290;
				this.match(P4grammarParser.PREPROC_LINE);
				}
				break;
			}
		}
	...
	public ppIncludeFileName(): PpIncludeFileNameContext {
		...
		this.enterRule(_localctx, 10, P4grammarParser.RULE_ppIncludeFileName);
		try {
			this.state = 309;
			this._errHandler.sync(this);
			...
			case 1:
				...
				{
				this.state = 293;
				this.match(P4grammarParser.STRING_LITERAL);
				}
				break;
			...
			case 2:
				...
				{
				this.state = 294;
				this.match(P4grammarParser.L_ANGLE);
				this.state = 295;
				this.ppIncludeFileName();
				this.state = 296;
				this.match(P4grammarParser.R_ANGLE);
				}
				break;
			...
			case 4:
				...
				this.name();
				this.state = 300;
				this.match(P4grammarParser.DOT);
				this.state = 301;
				this.name();
				}
				break;
			...
			case 5:
				...
				{
				this.state = 303;
				this.match(P4grammarParser.T__0);
				this.state = 304;
				this.ppIncludeFileName();
				}
				break;
			...
			case 6:
				...
				{
				this.state = 305;
				this.match(P4grammarParser.T__1);
				this.state = 306;
				this.ppIncludeFileName();
				}
				break;
			...
			case 7:
				...
				{
				this.state = 307;
				this.match(P4grammarParser.DIV);
				this.state = 308;
				this.ppIncludeFileName();
				}
				break;
	...
	public nonTypeName(): NonTypeNameContext {
		...
		this.enterRule(_localctx, 12, P4grammarParser.RULE_nonTypeName);
		try {
			this.state = 318;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case P4grammarParser.IDENTIFIER:
			case P4grammarParser.TYPE_IDENTIFIER:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 311;
				this.type_or_id();
				...
				break;
			case P4grammarParser.APPLY:
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 312;
				this.match(P4grammarParser.APPLY);
				}
				break;
			case P4grammarParser.KEY:
				this.enterOuterAlt(_localctx, 3);
				{
				this.state = 313;
				this.match(P4grammarParser.KEY);
				}
				break;
			case P4grammarParser.ACTIONS:
				this.enterOuterAlt(_localctx, 4);
				{
				this.state = 314;
				this.match(P4grammarParser.ACTIONS);
				}
				break;
			case P4grammarParser.STATE:
				this.enterOuterAlt(_localctx, 5);
				{
				this.state = 315;
				this.match(P4grammarParser.STATE);
				}
				break;
			case P4grammarParser.ENTRIES:
				this.enterOuterAlt(_localctx, 6);
				{
				this.state = 316;
				this.match(P4grammarParser.ENTRIES);
				}
				break;
			case P4grammarParser.TYPE:
				this.enterOuterAlt(_localctx, 7);
				{
				this.state = 317;
				this.match(P4grammarParser.TYPE);
				}
				break;
			default:
	...
	public name(): NameContext {
		...
		this.enterRule(_localctx, 14, P4grammarParser.RULE_name);
		try {
			this.state = 322;
			this._errHandler.sync(this);
	...
	public nonTableKwName(): NonTableKwNameContext {
		...
		this.enterRule(_localctx, 16, P4grammarParser.RULE_nonTableKwName);
		try {
			this.state = 328;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public optCONST(): OptCONSTContext {
		...
		this.enterRule(_localctx, 18, P4grammarParser.RULE_optCONST);
		try {
			this.state = 332;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			...
			case P4grammarParser.TYPE_IDENTIFIER:
				...
				break;
			case P4grammarParser.CONST:
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 331;
				this.match(P4grammarParser.CONST);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public optAnnotations(): OptAnnotationsContext {
		...
		this.enterRule(_localctx, 20, P4grammarParser.RULE_optAnnotations);
		try {
			this.state = 336;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case P4grammarParser.ABSTRACT:
			case P4grammarParser.ACTION:
			case P4grammarParser.ACTIONS:
			case P4grammarParser.APPLY:
			case P4grammarParser.BOOL:
			case P4grammarParser.BIT:
			case P4grammarParser.CONST:
			case P4grammarParser.CONTROL:
			case P4grammarParser.ENTRIES:
			case P4grammarParser.ENUM:
			case P4grammarParser.ERROR:
			case P4grammarParser.EXTERN:
			case P4grammarParser.HEADER:
			case P4grammarParser.HEADER_UNION:
			case P4grammarParser.IN:
			case P4grammarParser.INOUT:
			case P4grammarParser.INT:
			case P4grammarParser.KEY:
			case P4grammarParser.TYPE:
			case P4grammarParser.OUT:
			case P4grammarParser.PARSER:
			case P4grammarParser.PACKAGE:
			case P4grammarParser.STATE:
			case P4grammarParser.STRUCT:
			case P4grammarParser.TABLE:
			case P4grammarParser.TUPLE:
			case P4grammarParser.TYPEDEF:
			case P4grammarParser.VARBIT:
			case P4grammarParser.VALUESET:
			case P4grammarParser.VOID:
			case P4grammarParser.L_BRACE:
			case P4grammarParser.DOT:
			case P4grammarParser.SEMICOLON:
			case P4grammarParser.IDENTIFIER:
			case P4grammarParser.TYPE_IDENTIFIER:
				this.enterOuterAlt(_localctx, 1);
				// tslint:disable-next-line:no-empty
				...
				break;
			case P4grammarParser.PRAGMA:
			case P4grammarParser.AT:
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 335;
				this.annotations(0);
	...
	public annotations(_p?: number): AnnotationsContext {
		...
		this.enterRecursionRule(_localctx, 22, P4grammarParser.RULE_annotations, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_annotations);
					this.state = 341;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public annotation(): AnnotationContext {
		...
		this.enterRule(_localctx, 24, P4grammarParser.RULE_annotation);
		try {
			this.state = 360;
			this._errHandler.sync(this);
			...
			case 2:
				...
				this.name();
				this.state = 352;
				this.match(P4grammarParser.L_PAREN);
				this.state = 353;
				this.annotationBody(0);
				this.state = 354;
				this.match(P4grammarParser.R_PAREN);
				}
				break;
			...
			case 3:
				...
				{
				this.state = 356;
				this.match(P4grammarParser.PRAGMA);
				this.state = 357;
				this.name();
				this.state = 358;
				this.annotationBody(0);
	...
	public annotationBody(_p?: number): AnnotationBodyContext {
		...
		this.enterRecursionRule(_localctx, 26, P4grammarParser.RULE_annotationBody, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_annotationBody);
						this.state = 363;
						if (!(this.precpred(this._ctx, 2))) {
							throw new FailedPredicateException(this, "this.precpred(this._ctx, 2)");
						}
	...
	public annotationToken(): AnnotationTokenContext {
		...
		this.enterRule(_localctx, 28, P4grammarParser.RULE_annotationToken);
		try {
			this.state = 458;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case P4grammarParser.UNEXPECTED_TOKEN:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 375;
				this.match(P4grammarParser.UNEXPECTED_TOKEN);
				}
				break;
			case P4grammarParser.ABSTRACT:
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 376;
				this.match(P4grammarParser.ABSTRACT);
				}
				break;
			case P4grammarParser.ACTION:
				this.enterOuterAlt(_localctx, 3);
				{
				this.state = 377;
				this.match(P4grammarParser.ACTION);
				}
				break;
			case P4grammarParser.ACTIONS:
				this.enterOuterAlt(_localctx, 4);
			...
			case P4grammarParser.BOOL:
				...
				{
				this.state = 380;
				this.match(P4grammarParser.BOOL);
				}
				break;
			case P4grammarParser.BIT:
				this.enterOuterAlt(_localctx, 7);
				{
				this.state = 381;
				this.match(P4grammarParser.BIT);
				}
				break;
			case P4grammarParser.CONST:
				this.enterOuterAlt(_localctx, 8);
			...
			case P4grammarParser.CONTROL:
				...
				{
				this.state = 383;
				this.match(P4grammarParser.CONTROL);
				}
				break;
			case P4grammarParser.DEFAULT:
				this.enterOuterAlt(_localctx, 10);
				{
				this.state = 384;
				this.match(P4grammarParser.DEFAULT);
				}
				break;
			case P4grammarParser.ELSE:
				this.enterOuterAlt(_localctx, 11);
				{
				this.state = 385;
				this.match(P4grammarParser.ELSE);
				}
				break;
			case P4grammarParser.ENTRIES:
			...
			case P4grammarParser.ENUM:
				...
				{
				this.state = 387;
				this.match(P4grammarParser.ENUM);
				}
				break;
			case P4grammarParser.ERROR:
				...
				{
				this.state = 388;
				this.match(P4grammarParser.ERROR);
				}
				break;
			case P4grammarParser.EXIT:
				this.enterOuterAlt(_localctx, 15);
				{
				this.state = 389;
				this.match(P4grammarParser.EXIT);
				}
				break;
			case P4grammarParser.EXTERN:
				...
				{
				this.state = 390;
				this.match(P4grammarParser.EXTERN);
				}
				break;
			case P4grammarParser.FALSE:
				this.enterOuterAlt(_localctx, 17);
				{
				this.state = 391;
				this.match(P4grammarParser.FALSE);
				}
				break;
			case P4grammarParser.HEADER:
				...
				{
				this.state = 392;
				this.match(P4grammarParser.HEADER);
				}
				break;
			case P4grammarParser.HEADER_UNION:
				...
				{
				this.state = 393;
				this.match(P4grammarParser.HEADER_UNION);
				}
				break;
			case P4grammarParser.IF:
				this.enterOuterAlt(_localctx, 20);
				{
				this.state = 394;
				this.match(P4grammarParser.IF);
				}
				break;
			case P4grammarParser.IN:
			...
			case P4grammarParser.INOUT:
				...
				{
				this.state = 396;
				this.match(P4grammarParser.INOUT);
				}
				break;
			case P4grammarParser.INT:
				...
				{
				this.state = 397;
				this.match(P4grammarParser.INT);
				}
				break;
			case P4grammarParser.KEY:
				...
				break;
			case P4grammarParser.MATCH_KIND:
				this.enterOuterAlt(_localctx, 25);
				{
				this.state = 399;
				this.match(P4grammarParser.MATCH_KIND);
				}
				break;
			case P4grammarParser.TYPE:
			...
			case P4grammarParser.OUT:
				...
				{
				this.state = 401;
				this.match(P4grammarParser.OUT);
				}
				break;
			case P4grammarParser.PARSER:
				...
				{
				this.state = 402;
				this.match(P4grammarParser.PARSER);
				}
				break;
			case P4grammarParser.PACKAGE:
				...
				{
				this.state = 403;
				this.match(P4grammarParser.PACKAGE);
				}
				break;
			case P4grammarParser.PRAGMA:
				...
				break;
			case P4grammarParser.RETURN:
				this.enterOuterAlt(_localctx, 31);
				{
				this.state = 405;
				this.match(P4grammarParser.RETURN);
				}
				break;
			case P4grammarParser.SELECT:
				this.enterOuterAlt(_localctx, 32);
				{
				this.state = 406;
				this.match(P4grammarParser.SELECT);
				}
				break;
			case P4grammarParser.STATE:
			...
			case P4grammarParser.STRUCT:
				...
				{
				this.state = 408;
				this.match(P4grammarParser.STRUCT);
				}
				break;
			case P4grammarParser.SWITCH:
				this.enterOuterAlt(_localctx, 35);
				{
				this.state = 409;
				this.match(P4grammarParser.SWITCH);
				}
				break;
			case P4grammarParser.TABLE:
				...
				{
				this.state = 410;
				this.match(P4grammarParser.TABLE);
				}
				break;
			case P4grammarParser.THIS:
				this.enterOuterAlt(_localctx, 37);
				{
				this.state = 411;
				this.match(P4grammarParser.THIS);
				}
				break;
			case P4grammarParser.TRANSITION:
				this.enterOuterAlt(_localctx, 38);
				{
				this.state = 412;
				this.match(P4grammarParser.TRANSITION);
				}
				break;
			case P4grammarParser.TRUE:
				this.enterOuterAlt(_localctx, 39);
				{
				this.state = 413;
				this.match(P4grammarParser.TRUE);
				}
				break;
			case P4grammarParser.TUPLE:
				...
				{
				this.state = 414;
				this.match(P4grammarParser.TUPLE);
				}
				break;
			case P4grammarParser.TYPEDEF:
				...
				{
				this.state = 415;
				this.match(P4grammarParser.TYPEDEF);
				}
				break;
			case P4grammarParser.VARBIT:
				...
				{
				this.state = 416;
				this.match(P4grammarParser.VARBIT);
				}
				break;
			case P4grammarParser.VALUESET:
				...
				{
				this.state = 417;
				this.match(P4grammarParser.VALUESET);
				}
				break;
			case P4grammarParser.VOID:
				...
				{
				this.state = 418;
				this.match(P4grammarParser.VOID);
				}
				break;
			case P4grammarParser.DONTCARE:
				this.enterOuterAlt(_localctx, 45);
				{
				this.state = 419;
				this.match(P4grammarParser.DONTCARE);
				}
				break;
			case P4grammarParser.IDENTIFIER:
			case P4grammarParser.TYPE_IDENTIFIER:
				...
				break;
			case P4grammarParser.STRING_LITERAL:
				...
				break;
			case P4grammarParser.INTEGER:
				this.enterOuterAlt(_localctx, 48);
				{
				this.state = 422;
				this.match(P4grammarParser.INTEGER);
				}
				break;
			case P4grammarParser.MASK:
				this.enterOuterAlt(_localctx, 49);
				{
				this.state = 423;
				this.match(P4grammarParser.MASK);
				}
				break;
			case P4grammarParser.RANGE:
				this.enterOuterAlt(_localctx, 50);
				{
				this.state = 424;
				this.match(P4grammarParser.RANGE);
				}
				break;
			case P4grammarParser.SHL:
				this.enterOuterAlt(_localctx, 51);
				{
				this.state = 425;
				this.match(P4grammarParser.SHL);
				}
				break;
			case P4grammarParser.AND:
				this.enterOuterAlt(_localctx, 52);
				{
				this.state = 426;
				this.match(P4grammarParser.AND);
				}
				break;
			case P4grammarParser.OR:
				this.enterOuterAlt(_localctx, 53);
				{
				this.state = 427;
				this.match(P4grammarParser.OR);
				}
				break;
			case P4grammarParser.EQ:
				this.enterOuterAlt(_localctx, 54);
				{
				this.state = 428;
				this.match(P4grammarParser.EQ);
				}
				break;
			case P4grammarParser.NE:
				this.enterOuterAlt(_localctx, 55);
				{
				this.state = 429;
				this.match(P4grammarParser.NE);
				}
				break;
			case P4grammarParser.GE:
				this.enterOuterAlt(_localctx, 56);
				{
				this.state = 430;
				this.match(P4grammarParser.GE);
				}
				break;
			case P4grammarParser.LE:
				this.enterOuterAlt(_localctx, 57);
				{
				this.state = 431;
				this.match(P4grammarParser.LE);
				}
				break;
			case P4grammarParser.PP:
				this.enterOuterAlt(_localctx, 58);
				{
				this.state = 432;
				this.match(P4grammarParser.PP);
				}
				break;
			case P4grammarParser.PLUS:
				this.enterOuterAlt(_localctx, 59);
				{
				this.state = 433;
				this.match(P4grammarParser.PLUS);
				}
				break;
			case P4grammarParser.PLUS_SAT:
				this.enterOuterAlt(_localctx, 60);
				{
				this.state = 434;
				this.match(P4grammarParser.PLUS_SAT);
				}
				break;
			case P4grammarParser.MINUS:
				this.enterOuterAlt(_localctx, 61);
				{
				this.state = 435;
				this.match(P4grammarParser.MINUS);
				}
				break;
			case P4grammarParser.MINUS_SAT:
				this.enterOuterAlt(_localctx, 62);
				{
				this.state = 436;
				this.match(P4grammarParser.MINUS_SAT);
				}
				break;
			case P4grammarParser.MUL:
				this.enterOuterAlt(_localctx, 63);
				{
				this.state = 437;
				this.match(P4grammarParser.MUL);
				}
				break;
			case P4grammarParser.DIV:
				...
				break;
			case P4grammarParser.MOD:
				this.enterOuterAlt(_localctx, 65);
				{
				this.state = 439;
				this.match(P4grammarParser.MOD);
				}
				break;
			case P4grammarParser.BIT_OR:
				this.enterOuterAlt(_localctx, 66);
				{
				this.state = 440;
				this.match(P4grammarParser.BIT_OR);
				}
				break;
			case P4grammarParser.BIT_AND:
				this.enterOuterAlt(_localctx, 67);
				{
				this.state = 441;
				this.match(P4grammarParser.BIT_AND);
				}
				break;
			case P4grammarParser.BIT_XOR:
				this.enterOuterAlt(_localctx, 68);
				{
				this.state = 442;
				this.match(P4grammarParser.BIT_XOR);
				}
				break;
			case P4grammarParser.COMPLEMENT:
				this.enterOuterAlt(_localctx, 69);
				{
				this.state = 443;
				this.match(P4grammarParser.COMPLEMENT);
				}
				break;
			case P4grammarParser.L_BRACKET:
				this.enterOuterAlt(_localctx, 70);
				{
				this.state = 444;
				this.match(P4grammarParser.L_BRACKET);
				}
				break;
			case P4grammarParser.R_BRACKET:
				this.enterOuterAlt(_localctx, 71);
				{
				this.state = 445;
				this.match(P4grammarParser.R_BRACKET);
				}
				break;
			case P4grammarParser.L_BRACE:
				...
				{
				this.state = 446;
				this.match(P4grammarParser.L_BRACE);
				}
				break;
			case P4grammarParser.R_BRACE:
				this.enterOuterAlt(_localctx, 73);
				{
				this.state = 447;
				this.match(P4grammarParser.R_BRACE);
				}
				break;
			case P4grammarParser.L_ANGLE:
			...
			case P4grammarParser.R_ANGLE:
				...
				break;
			case P4grammarParser.NOT:
				this.enterOuterAlt(_localctx, 76);
				{
				this.state = 450;
				this.match(P4grammarParser.NOT);
				}
				break;
			case P4grammarParser.COLON:
				this.enterOuterAlt(_localctx, 77);
				{
				this.state = 451;
				this.match(P4grammarParser.COLON);
				}
				break;
			case P4grammarParser.COMMA:
				this.enterOuterAlt(_localctx, 78);
				{
				this.state = 452;
				this.match(P4grammarParser.COMMA);
				}
				break;
			case P4grammarParser.QUESTION:
				this.enterOuterAlt(_localctx, 79);
				{
				this.state = 453;
				this.match(P4grammarParser.QUESTION);
				}
				break;
			case P4grammarParser.DOT:
				...
				break;
			case P4grammarParser.ASSIGN:
				this.enterOuterAlt(_localctx, 81);
				{
				this.state = 455;
				this.match(P4grammarParser.ASSIGN);
				}
				break;
			case P4grammarParser.SEMICOLON:
	...
	public kvList(_p?: number): KvListContext {
		...
		this.enterRecursionRule(_localctx, 30, P4grammarParser.RULE_kvList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_kvList);
					this.state = 463;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public kvPair(): KvPairContext {
		...
		this.enterRule(_localctx, 32, P4grammarParser.RULE_kvPair);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 471;
	...
	public parameterList(): ParameterListContext {
		...
		this.enterRule(_localctx, 34, P4grammarParser.RULE_parameterList);
		try {
			this.state = 477;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case P4grammarParser.R_PAREN:
				this.enterOuterAlt(_localctx, 1);
				// tslint:disable-next-line:no-empty
				{
				}
	...
	public nonEmptyParameterList(_p?: number): NonEmptyParameterListContext {
		...
		this.enterRecursionRule(_localctx, 36, P4grammarParser.RULE_nonEmptyParameterList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_nonEmptyParameterList);
					this.state = 482;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public parameter(): ParameterContext {
		...
		this.enterRule(_localctx, 38, P4grammarParser.RULE_parameter);
		try {
			this.state = 502;
			this._errHandler.sync(this);
	...
	public direction(): DirectionContext {
		...
		this.enterRule(_localctx, 40, P4grammarParser.RULE_direction);
		try {
			this.state = 508;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public packageTypeDeclaration(): PackageTypeDeclarationContext {
		...
		this.enterRule(_localctx, 42, P4grammarParser.RULE_packageTypeDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 510;
	...
	public instantiation(): InstantiationContext {
		...
		this.enterRule(_localctx, 44, P4grammarParser.RULE_instantiation);
		try {
			this.state = 552;
			this._errHandler.sync(this);
	...
	public objInitializer(): ObjInitializerContext {
		...
		this.enterRule(_localctx, 46, P4grammarParser.RULE_objInitializer);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 554;
	...
	public objDeclarations(_p?: number): ObjDeclarationsContext {
		...
		this.enterRecursionRule(_localctx, 48, P4grammarParser.RULE_objDeclarations, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_objDeclarations);
					this.state = 559;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public objDeclaration(): ObjDeclarationContext {
		...
		this.enterRule(_localctx, 50, P4grammarParser.RULE_objDeclaration);
		try {
			this.state = 568;
			this._errHandler.sync(this);
	...
	public optConstructorParameters(): OptConstructorParametersContext {
		...
		this.enterRule(_localctx, 52, P4grammarParser.RULE_optConstructorParameters);
		try {
			this.state = 575;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public dotPrefix(): DotPrefixContext {
		...
		this.enterRule(_localctx, 54, P4grammarParser.RULE_dotPrefix);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 577;
	...
	public parserDeclaration(): ParserDeclarationContext {
		...
		this.enterRule(_localctx, 56, P4grammarParser.RULE_parserDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 579;
	...
	public parserLocalElements(_p?: number): ParserLocalElementsContext {
		...
		this.enterRecursionRule(_localctx, 58, P4grammarParser.RULE_parserLocalElements, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_parserLocalElements);
					this.state = 587;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public parserLocalElement(): ParserLocalElementContext {
		...
		this.enterRule(_localctx, 60, P4grammarParser.RULE_parserLocalElement);
		try {
			this.state = 598;
			this._errHandler.sync(this);
	...
	public parserTypeDeclaration(): ParserTypeDeclarationContext {
		...
		this.enterRule(_localctx, 62, P4grammarParser.RULE_parserTypeDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 600;
	...
	public parserStates(_p?: number): ParserStatesContext {
		...
		this.enterRecursionRule(_localctx, 64, P4grammarParser.RULE_parserStates, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_parserStates);
					this.state = 611;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public parserState(): ParserStateContext {
		...
		this.enterRule(_localctx, 66, P4grammarParser.RULE_parserState);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 618;
	...
	public parserStatements(_p?: number): ParserStatementsContext {
		...
		this.enterRecursionRule(_localctx, 68, P4grammarParser.RULE_parserStatements, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_parserStatements);
					this.state = 627;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public parserStatement(): ParserStatementContext {
		...
		this.enterRule(_localctx, 70, P4grammarParser.RULE_parserStatement);
		try {
			this.state = 639;
			this._errHandler.sync(this);
	...
	public parserBlockStatement(): ParserBlockStatementContext {
		...
		this.enterRule(_localctx, 72, P4grammarParser.RULE_parserBlockStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 641;
	...
	public transitionStatement(): TransitionStatementContext {
		...
		this.enterRule(_localctx, 74, P4grammarParser.RULE_transitionStatement);
		try {
			this.state = 649;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public stateExpression(): StateExpressionContext {
		...
		this.enterRule(_localctx, 76, P4grammarParser.RULE_stateExpression);
		try {
			this.state = 655;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public selectExpression(): SelectExpressionContext {
		...
		this.enterRule(_localctx, 78, P4grammarParser.RULE_selectExpression);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 657;
	...
	public selectCaseList(_p?: number): SelectCaseListContext {
		...
		this.enterRecursionRule(_localctx, 80, P4grammarParser.RULE_selectCaseList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_selectCaseList);
					this.state = 666;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public selectCase(): SelectCaseContext {
		...
		this.enterRule(_localctx, 82, P4grammarParser.RULE_selectCase);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 673;
	...
	public keysetExpression(): KeysetExpressionContext {
		...
		this.enterRule(_localctx, 84, P4grammarParser.RULE_keysetExpression);
		try {
			this.state = 680;
			this._errHandler.sync(this);
	...
	public tupleKeysetExpression(): TupleKeysetExpressionContext {
		...
		this.enterRule(_localctx, 86, P4grammarParser.RULE_tupleKeysetExpression);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 682;
	...
	public simpleExpressionList(_p?: number): SimpleExpressionListContext {
		...
		this.enterRecursionRule(_localctx, 88, P4grammarParser.RULE_simpleExpressionList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_simpleExpressionList);
					this.state = 691;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public simpleKeysetExpression(): SimpleKeysetExpressionContext {
		...
		this.enterRule(_localctx, 90, P4grammarParser.RULE_simpleKeysetExpression);
		try {
			this.state = 710;
			this._errHandler.sync(this);
	...
	public valueSetDeclaration(): ValueSetDeclarationContext {
		...
		this.enterRule(_localctx, 92, P4grammarParser.RULE_valueSetDeclaration);
		try {
			this.state = 745;
			this._errHandler.sync(this);
	...
	public controlDeclaration(): ControlDeclarationContext {
		...
		this.enterRule(_localctx, 94, P4grammarParser.RULE_controlDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 747;
	...
	public controlTypeDeclaration(): ControlTypeDeclarationContext {
		...
		this.enterRule(_localctx, 96, P4grammarParser.RULE_controlTypeDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 755;
	...
	public controlLocalDeclarations(_p?: number): ControlLocalDeclarationsContext {
		...
		this.enterRecursionRule(_localctx, 98, P4grammarParser.RULE_controlLocalDeclarations, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_controlLocalDeclarations);
					this.state = 764;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public controlLocalDeclaration(): ControlLocalDeclarationContext {
		...
		this.enterRule(_localctx, 100, P4grammarParser.RULE_controlLocalDeclaration);
		try {
			this.state = 776;
			this._errHandler.sync(this);
	...
	public controlBody(): ControlBodyContext {
		...
		this.enterRule(_localctx, 102, P4grammarParser.RULE_controlBody);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 778;
	...
	public externDeclaration(): ExternDeclarationContext {
		...
		this.enterRule(_localctx, 104, P4grammarParser.RULE_externDeclaration);
		try {
			this.state = 798;
			this._errHandler.sync(this);
	...
	public methodPrototypes(_p?: number): MethodPrototypesContext {
		...
		this.enterRecursionRule(_localctx, 106, P4grammarParser.RULE_methodPrototypes, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_methodPrototypes);
					this.state = 801;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public functionPrototype(): FunctionPrototypeContext {
		...
		this.enterRule(_localctx, 108, P4grammarParser.RULE_functionPrototype);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 808;
	...
	public methodPrototype(): MethodPrototypeContext {
		...
		this.enterRule(_localctx, 110, P4grammarParser.RULE_methodPrototype);
		try {
			this.state = 831;
			this._errHandler.sync(this);
	...
	public typeRef(): TypeRefContext {
		...
		this.enterRule(_localctx, 112, P4grammarParser.RULE_typeRef);
		try {
			this.state = 838;
			this._errHandler.sync(this);
	...
	public namedType(): NamedTypeContext {
		...
		this.enterRule(_localctx, 114, P4grammarParser.RULE_namedType);
		try {
			this.state = 842;
			this._errHandler.sync(this);
	...
	public prefixedType(): PrefixedTypeContext {
		...
		this.enterRule(_localctx, 116, P4grammarParser.RULE_prefixedType);
		try {
			this.state = 848;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public typeName(): TypeNameContext {
		...
		this.enterRule(_localctx, 118, P4grammarParser.RULE_typeName);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 850;
	...
	public tupleType(): TupleTypeContext {
		...
		this.enterRule(_localctx, 120, P4grammarParser.RULE_tupleType);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 852;
	...
	public headerStackType(): HeaderStackTypeContext {
		...
		this.enterRule(_localctx, 122, P4grammarParser.RULE_headerStackType);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 857;
	...
	public specializedType(): SpecializedTypeContext {
		...
		this.enterRule(_localctx, 124, P4grammarParser.RULE_specializedType);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 862;
	...
	public baseType(): BaseTypeContext {
		...
		this.enterRule(_localctx, 126, P4grammarParser.RULE_baseType);
		try {
			this.state = 904;
			this._errHandler.sync(this);
	...
	public typeOrVoid(): TypeOrVoidContext {
		...
		this.enterRule(_localctx, 128, P4grammarParser.RULE_typeOrVoid);
		try {
			this.state = 909;
			this._errHandler.sync(this);
	...
	public optTypeParameters(): OptTypeParametersContext {
		...
		this.enterRule(_localctx, 130, P4grammarParser.RULE_optTypeParameters);
		try {
			this.state = 916;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public typeParameterList(_p?: number): TypeParameterListContext {
		...
		this.enterRecursionRule(_localctx, 132, P4grammarParser.RULE_typeParameterList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_typeParameterList);
					this.state = 921;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public typeArg(): TypeArgContext {
		...
		this.enterRule(_localctx, 134, P4grammarParser.RULE_typeArg);
		try {
			this.state = 933;
			this._errHandler.sync(this);
	...
	public typeArgumentList(_p?: number): TypeArgumentListContext {
		...
		this.enterRecursionRule(_localctx, 136, P4grammarParser.RULE_typeArgumentList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_typeArgumentList);
					this.state = 939;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public realTypeArg(): RealTypeArgContext {
		...
		this.enterRule(_localctx, 138, P4grammarParser.RULE_realTypeArg);
		try {
			this.state = 950;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public realTypeArgumentList(_p?: number): RealTypeArgumentListContext {
		...
		this.enterRecursionRule(_localctx, 140, P4grammarParser.RULE_realTypeArgumentList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_realTypeArgumentList);
					this.state = 955;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public typeDeclaration(): TypeDeclarationContext {
		...
		this.enterRule(_localctx, 142, P4grammarParser.RULE_typeDeclaration);
		try {
			this.state = 976;
			this._errHandler.sync(this);
	...
	public derivedTypeDeclaration(): DerivedTypeDeclarationContext {
		...
		this.enterRule(_localctx, 144, P4grammarParser.RULE_derivedTypeDeclaration);
		try {
			this.state = 982;
			this._errHandler.sync(this);
	...
	public headerTypeDeclaration(): HeaderTypeDeclarationContext {
		...
		this.enterRule(_localctx, 146, P4grammarParser.RULE_headerTypeDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 984;
	...
	public structTypeDeclaration(): StructTypeDeclarationContext {
		...
		this.enterRule(_localctx, 148, P4grammarParser.RULE_structTypeDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 991;
	...
	public headerUnionDeclaration(): HeaderUnionDeclarationContext {
		...
		this.enterRule(_localctx, 150, P4grammarParser.RULE_headerUnionDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 998;
	...
	public structFieldList(_p?: number): StructFieldListContext {
		...
		this.enterRecursionRule(_localctx, 152, P4grammarParser.RULE_structFieldList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_structFieldList);
					this.state = 1006;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public structField(): StructFieldContext {
		...
		this.enterRule(_localctx, 154, P4grammarParser.RULE_structField);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1013;
	...
	public enumDeclaration(): EnumDeclarationContext {
		...
		this.enterRule(_localctx, 156, P4grammarParser.RULE_enumDeclaration);
		try {
			this.state = 1036;
			this._errHandler.sync(this);
	...
	public specifiedIdentifierList(_p?: number): SpecifiedIdentifierListContext {
		...
		this.enterRecursionRule(_localctx, 158, P4grammarParser.RULE_specifiedIdentifierList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_specifiedIdentifierList);
					this.state = 1041;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public specifiedIdentifier(): SpecifiedIdentifierContext {
		...
		this.enterRule(_localctx, 160, P4grammarParser.RULE_specifiedIdentifier);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1049;
	...
	public errorDeclaration(): ErrorDeclarationContext {
		...
		this.enterRule(_localctx, 162, P4grammarParser.RULE_errorDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1053;
	...
	public matchKindDeclaration(): MatchKindDeclarationContext {
		...
		this.enterRule(_localctx, 164, P4grammarParser.RULE_matchKindDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1058;
	...
	public identifierList(_p?: number): IdentifierListContext {
		...
		this.enterRecursionRule(_localctx, 166, P4grammarParser.RULE_identifierList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_identifierList);
					this.state = 1066;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public typedefDeclaration(): TypedefDeclarationContext {
		...
		this.enterRule(_localctx, 168, P4grammarParser.RULE_typedefDeclaration);
		try {
			this.state = 1094;
			this._errHandler.sync(this);
	...
	public assignmentOrMethodCallStatement(): AssignmentOrMethodCallStatementContext {
		...
		this.enterRule(_localctx, 170, P4grammarParser.RULE_assignmentOrMethodCallStatement);
		try {
			this.state = 1116;
			this._errHandler.sync(this);
	...
	public emptyStatement(): EmptyStatementContext {
		...
		this.enterRule(_localctx, 172, P4grammarParser.RULE_emptyStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1118;
	...
	public exitStatement(): ExitStatementContext {
		...
		this.enterRule(_localctx, 174, P4grammarParser.RULE_exitStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1120;
	...
	public returnStatement(): ReturnStatementContext {
		...
		this.enterRule(_localctx, 176, P4grammarParser.RULE_returnStatement);
		try {
			this.state = 1129;
			this._errHandler.sync(this);
	...
	public conditionalStatement(): ConditionalStatementContext {
		...
		this.enterRule(_localctx, 178, P4grammarParser.RULE_conditionalStatement);
		try {
			this.state = 1145;
			this._errHandler.sync(this);
	...
	public directApplication(): DirectApplicationContext {
		...
		this.enterRule(_localctx, 180, P4grammarParser.RULE_directApplication);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1147;
	...
	public statement(): StatementContext {
		...
		this.enterRule(_localctx, 182, P4grammarParser.RULE_statement);
		try {
			this.state = 1163;
			this._errHandler.sync(this);
	...
	public blockStatement(): BlockStatementContext {
		...
		this.enterRule(_localctx, 184, P4grammarParser.RULE_blockStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1165;
	...
	public statOrDeclList(_p?: number): StatOrDeclListContext {
		...
		this.enterRecursionRule(_localctx, 186, P4grammarParser.RULE_statOrDeclList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_statOrDeclList);
					this.state = 1171;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public switchStatement(): SwitchStatementContext {
		...
		this.enterRule(_localctx, 188, P4grammarParser.RULE_switchStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1178;
	...
	public switchCases(_p?: number): SwitchCasesContext {
		...
		this.enterRecursionRule(_localctx, 190, P4grammarParser.RULE_switchCases, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_switchCases);
					this.state = 1187;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public switchCase(): SwitchCaseContext {
		...
		this.enterRule(_localctx, 192, P4grammarParser.RULE_switchCase);
		try {
			this.state = 1201;
			this._errHandler.sync(this);
	...
	public switchLabel(): SwitchLabelContext {
		...
		this.enterRule(_localctx, 194, P4grammarParser.RULE_switchLabel);
		try {
			this.state = 1205;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public statementOrDeclaration(): StatementOrDeclarationContext {
		...
		this.enterRule(_localctx, 196, P4grammarParser.RULE_statementOrDeclaration);
		try {
			this.state = 1211;
			this._errHandler.sync(this);
	...
	public tableDeclaration(): TableDeclarationContext {
		...
		this.enterRule(_localctx, 198, P4grammarParser.RULE_tableDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1213;
	...
	public tablePropertyList(_p?: number): TablePropertyListContext {
		...
		this.enterRecursionRule(_localctx, 200, P4grammarParser.RULE_tablePropertyList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_tablePropertyList);
					this.state = 1223;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public tableProperty(): TablePropertyContext {
		...
		this.enterRule(_localctx, 202, P4grammarParser.RULE_tableProperty);
		try {
			this.state = 1257;
			this._errHandler.sync(this);
	...
	public keyElementList(_p?: number): KeyElementListContext {
		...
		this.enterRecursionRule(_localctx, 204, P4grammarParser.RULE_keyElementList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_keyElementList);
					this.state = 1260;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public keyElement(): KeyElementContext {
		...
		this.enterRule(_localctx, 206, P4grammarParser.RULE_keyElement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1267;
	...
	public actionList(_p?: number): ActionListContext {
		...
		this.enterRecursionRule(_localctx, 208, P4grammarParser.RULE_actionList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_actionList);
					this.state = 1274;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public actionRef(): ActionRefContext {
		...
		this.enterRule(_localctx, 210, P4grammarParser.RULE_actionRef);
		try {
			this.state = 1292;
			this._errHandler.sync(this);
	...
	public entry(): EntryContext {
		...
		this.enterRule(_localctx, 212, P4grammarParser.RULE_entry);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1294;
	...
	public actionBinding(): ActionBindingContext {
		...
		this.enterRule(_localctx, 214, P4grammarParser.RULE_actionBinding);
		try {
			this.state = 1313;
			this._errHandler.sync(this);
	...
	public entriesList(_p?: number): EntriesListContext {
		...
		this.enterRecursionRule(_localctx, 216, P4grammarParser.RULE_entriesList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_entriesList);
					this.state = 1318;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public actionDeclaration(): ActionDeclarationContext {
		...
		this.enterRule(_localctx, 218, P4grammarParser.RULE_actionDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1325;
	...
	public variableDeclaration(): VariableDeclarationContext {
		...
		this.enterRule(_localctx, 220, P4grammarParser.RULE_variableDeclaration);
		try {
			this.state = 1344;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public constantDeclaration(): ConstantDeclarationContext {
		...
		this.enterRule(_localctx, 222, P4grammarParser.RULE_constantDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1346;
	...
	public optInitializer(): OptInitializerContext {
		...
		this.enterRule(_localctx, 224, P4grammarParser.RULE_optInitializer);
		try {
			this.state = 1357;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public initializer(): InitializerContext {
		...
		this.enterRule(_localctx, 226, P4grammarParser.RULE_initializer);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1359;
	...
	public functionDeclaration(): FunctionDeclarationContext {
		...
		this.enterRule(_localctx, 228, P4grammarParser.RULE_functionDeclaration);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 1361;
	...
	public argumentList(): ArgumentListContext {
		...
		this.enterRule(_localctx, 230, P4grammarParser.RULE_argumentList);
		try {
			this.state = 1366;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public nonEmptyArgList(_p?: number): NonEmptyArgListContext {
		...
		this.enterRecursionRule(_localctx, 232, P4grammarParser.RULE_nonEmptyArgList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_nonEmptyArgList);
					this.state = 1371;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public argument(): ArgumentContext {
		...
		this.enterRule(_localctx, 234, P4grammarParser.RULE_argument);
		try {
			this.state = 1385;
			this._errHandler.sync(this);
	...
	public expressionList(_p?: number): ExpressionListContext {
		...
		this.enterRecursionRule(_localctx, 236, P4grammarParser.RULE_expressionList, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_expressionList);
					this.state = 1391;
					if (!(this.precpred(this._ctx, 1))) {
						throw new FailedPredicateException(this, "this.precpred(this._ctx, 1)");
					}
	...
	public prefixedNonTypeName(): PrefixedNonTypeNameContext {
		...
		this.enterRule(_localctx, 238, P4grammarParser.RULE_prefixedNonTypeName);
		try {
			this.state = 1403;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public lvalue(_p?: number): LvalueContext {
		...
		this.enterRecursionRule(_localctx, 240, P4grammarParser.RULE_lvalue, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_lvalue);
						this.state = 1410;
	...
	public expression(_p?: number): ExpressionContext {
		...
		this.enterRecursionRule(_localctx, 242, P4grammarParser.RULE_expression, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, P4grammarParser.RULE_expression);
						this.state = 1475;
	...
	public type_or_id(): Type_or_idContext {
		...
		this.enterRule(_localctx, 244, P4grammarParser.RULE_type_or_id);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			if (!(_la === P4grammarParser.IDENTIFIER || _la === P4grammarParser.TYPE_IDENTIFIER)) {
	...
	public parserStateCondition(): ParserStateConditionContext {
		...
		this.enterRule(_localctx, 246, P4grammarParser.RULE_parserStateCondition);
		try {
			this.state = 1601;
			this._errHandler.sync(this);
	...
	public static readonly _serializedATN: string = Utils.join(
		[
			P4grammarParser._serializedATNSegment0,
			P4grammarParser._serializedATNSegment1,
			P4grammarParser._serializedATNSegment2,
		],
		"",
	);
	public static __ATN: ATN;
	public static get _ATN(): ATN {
		if (!P4grammarParser.__ATN) {
			P4grammarParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(P4grammarParser._serializedATN));
		}

		return P4grammarParser.__ATN;
	}
...
export class StartContext extends ParserRuleContext {
	...
	// @Override
	public exitRule(listener: P4grammarListener): void {
		if (listener.exitStart) {
			listener.exitStart(this);
		}
	}
	// @Override
	public accept<Result>(visitor: P4grammarVisitor<Result>): Result {
...
export class InputContext extends ParserRuleContext {
	...
	public SEMICOLON(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.SEMICOLON, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class PreprocessorLineContext extends ParserRuleContext {
	public PREPROC_INCLUDE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_INCLUDE, 0); }
	public ppIncludeFileName(): PpIncludeFileNameContext | undefined {
		return this.tryGetRuleContext(0, PpIncludeFileNameContext);
	}
	public PREPROC_DEFINE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_DEFINE, 0); }
	public expression(): ExpressionContext[];
	...
	public PREPROC_UNDEF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_UNDEF, 0); }
	public PREPROC_IFDEF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_IFDEF, 0); }
	public PREPROC_IFNDEF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_IFNDEF, 0); }
	public PREPROC_IF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_IF, 0); }
	public PREPROC_ELSEIF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_ELSEIF, 0); }
	public PREPROC_ELSE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_ELSE, 0); }
	public PREPROC_ENDIF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_ENDIF, 0); }
	public PREPROC_LINE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PREPROC_LINE, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class PpIncludeFileNameContext extends ParserRuleContext {
	public STRING_LITERAL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.STRING_LITERAL, 0); }
	public L_ANGLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.L_ANGLE, 0); }
	public ppIncludeFileName(): PpIncludeFileNameContext | undefined {
		return this.tryGetRuleContext(0, PpIncludeFileNameContext);
	}
	public R_ANGLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.R_ANGLE, 0); }
	public name(): NameContext[];
	...
	public DOT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DOT, 0); }
	public DIV(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DIV, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class NonTypeNameContext extends ParserRuleContext {
	...
	public APPLY(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.APPLY, 0); }
	public KEY(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.KEY, 0); }
	public ACTIONS(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ACTIONS, 0); }
	public STATE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.STATE, 0); }
	public ENTRIES(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ENTRIES, 0); }
	public TYPE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TYPE, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class OptCONSTContext extends ParserRuleContext {
	public CONST(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.CONST, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class AnnotationContext extends ParserRuleContext {
	public AT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.AT, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_PAREN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.L_PAREN, 0); }
	public annotationBody(): AnnotationBodyContext | undefined {
		return this.tryGetRuleContext(0, AnnotationBodyContext);
	}
	public R_PAREN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.R_PAREN, 0); }
	public PRAGMA(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PRAGMA, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class AnnotationTokenContext extends ParserRuleContext {
	public UNEXPECTED_TOKEN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.UNEXPECTED_TOKEN, 0); }
	public ABSTRACT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ABSTRACT, 0); }
	public ACTION(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ACTION, 0); }
	public ACTIONS(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ACTIONS, 0); }
	public APPLY(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.APPLY, 0); }
	public BOOL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.BOOL, 0); }
	public BIT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.BIT, 0); }
	public CONST(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.CONST, 0); }
	public CONTROL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.CONTROL, 0); }
	public DEFAULT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DEFAULT, 0); }
	public ELSE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ELSE, 0); }
	public ENTRIES(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ENTRIES, 0); }
	public ENUM(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ENUM, 0); }
	public ERROR(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ERROR, 0); }
	public EXIT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.EXIT, 0); }
	public EXTERN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.EXTERN, 0); }
	public FALSE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.FALSE, 0); }
	public HEADER(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.HEADER, 0); }
	public HEADER_UNION(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.HEADER_UNION, 0); }
	public IF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.IF, 0); }
	public IN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.IN, 0); }
	public INOUT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.INOUT, 0); }
	public INT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.INT, 0); }
	public KEY(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.KEY, 0); }
	public MATCH_KIND(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MATCH_KIND, 0); }
	public TYPE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TYPE, 0); }
	public OUT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.OUT, 0); }
	public PARSER(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PARSER, 0); }
	public PACKAGE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PACKAGE, 0); }
	public PRAGMA(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PRAGMA, 0); }
	public RETURN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.RETURN, 0); }
	public SELECT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.SELECT, 0); }
	public STATE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.STATE, 0); }
	public STRUCT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.STRUCT, 0); }
	public SWITCH(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.SWITCH, 0); }
	public TABLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TABLE, 0); }
	public THIS(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.THIS, 0); }
	public TRANSITION(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TRANSITION, 0); }
	public TRUE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TRUE, 0); }
	public TUPLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TUPLE, 0); }
	public TYPEDEF(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TYPEDEF, 0); }
	public VARBIT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.VARBIT, 0); }
	public VALUESET(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.VALUESET, 0); }
	public VOID(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.VOID, 0); }
	public DONTCARE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DONTCARE, 0); }
	public type_or_id(): Type_or_idContext | undefined {
		return this.tryGetRuleContext(0, Type_or_idContext);
	}
	public STRING_LITERAL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.STRING_LITERAL, 0); }
	public INTEGER(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.INTEGER, 0); }
	public MASK(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MASK, 0); }
	public RANGE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.RANGE, 0); }
	public SHL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.SHL, 0); }
	public AND(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.AND, 0); }
	public OR(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.OR, 0); }
	public EQ(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.EQ, 0); }
	public NE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.NE, 0); }
	public GE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.GE, 0); }
	public LE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.LE, 0); }
	public PP(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PP, 0); }
	public PLUS(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PLUS, 0); }
	public PLUS_SAT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.PLUS_SAT, 0); }
	public MINUS(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MINUS, 0); }
	public MINUS_SAT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MINUS_SAT, 0); }
	public MUL(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MUL, 0); }
	public DIV(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DIV, 0); }
	public MOD(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.MOD, 0); }
	public BIT_OR(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.BIT_OR, 0); }
	public BIT_AND(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.BIT_AND, 0); }
	public BIT_XOR(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.BIT_XOR, 0); }
	public COMPLEMENT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.COMPLEMENT, 0); }
	public L_BRACKET(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.L_BRACKET, 0); }
	public R_BRACKET(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.R_BRACKET, 0); }
	public L_BRACE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.L_BRACE, 0); }
	public R_BRACE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.R_BRACE, 0); }
	public L_ANGLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.L_ANGLE, 0); }
	public R_ANGLE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.R_ANGLE, 0); }
	public NOT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.NOT, 0); }
	public COLON(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.COLON, 0); }
	public COMMA(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.COMMA, 0); }
	public QUESTION(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.QUESTION, 0); }
	public DOT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.DOT, 0); }
	public ASSIGN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ASSIGN, 0); }
	public SEMICOLON(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.SEMICOLON, 0); }
	public AT(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.AT, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
...
export class KvPairContext extends ParserRuleContext {
	...
	public ASSIGN(): TerminalNode { return this.getToken(P4grammarParser.ASSIGN, 0); }
	public expression(): ExpressionContext {
...
export class PackageTypeDeclarationContext extends ParserRuleContext {
	...
	public PACKAGE(): TerminalNode { return this.getToken(P4grammarParser.PACKAGE, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public optTypeParameters(): OptTypeParametersContext {
	...
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
	public parameterList(): ParameterListContext {
		return this.getRuleContext(0, ParameterListContext);
	}
	public R_PAREN(): TerminalNode { return this.getToken(P4grammarParser.R_PAREN, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class InstantiationContext extends ParserRuleContext {
	...
	public SEMICOLON(): TerminalNode { return this.getToken(P4grammarParser.SEMICOLON, 0); }
	public ASSIGN(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.ASSIGN, 0); }
...
export class ObjInitializerContext extends ParserRuleContext {
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
	public objDeclarations(): ObjDeclarationsContext {
		return this.getRuleContext(0, ObjDeclarationsContext);
	}
	public R_BRACE(): TerminalNode { return this.getToken(P4grammarParser.R_BRACE, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class DotPrefixContext extends ParserRuleContext {
	public DOT(): TerminalNode { return this.getToken(P4grammarParser.DOT, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class ParserTypeDeclarationContext extends ParserRuleContext {
	...
	public PARSER(): TerminalNode { return this.getToken(P4grammarParser.PARSER, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public optTypeParameters(): OptTypeParametersContext {
...
export class ParserStateContext extends ParserRuleContext {
	...
	public STATE(): TerminalNode { return this.getToken(P4grammarParser.STATE, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class SelectExpressionContext extends ParserRuleContext {
	public SELECT(): TerminalNode { return this.getToken(P4grammarParser.SELECT, 0); }
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
	public expressionList(): ExpressionListContext {
...
export class SelectCaseContext extends ParserRuleContext {
	...
	public COLON(): TerminalNode { return this.getToken(P4grammarParser.COLON, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public SEMICOLON(): TerminalNode { return this.getToken(P4grammarParser.SEMICOLON, 0); }
...
export class TupleKeysetExpressionContext extends ParserRuleContext {
	...
	public COMMA(): TerminalNode { return this.getToken(P4grammarParser.COMMA, 0); }
	public simpleExpressionList(): SimpleExpressionListContext {
...
export class ValueSetDeclarationContext extends ParserRuleContext {
	...
	public VALUESET(): TerminalNode { return this.getToken(P4grammarParser.VALUESET, 0); }
	public L_ANGLE(): TerminalNode { return this.getToken(P4grammarParser.L_ANGLE, 0); }
	public baseType(): BaseTypeContext | undefined {
		return this.tryGetRuleContext(0, BaseTypeContext);
	}
	public R_ANGLE(): TerminalNode { return this.getToken(P4grammarParser.R_ANGLE, 0); }
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
...
export class ControlDeclarationContext extends ParserRuleContext {
	...
	public APPLY(): TerminalNode { return this.getToken(P4grammarParser.APPLY, 0); }
	public controlBody(): ControlBodyContext {
...
export class ControlTypeDeclarationContext extends ParserRuleContext {
	...
	public CONTROL(): TerminalNode { return this.getToken(P4grammarParser.CONTROL, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public optTypeParameters(): OptTypeParametersContext {
...
export class ExternDeclarationContext extends ParserRuleContext {
	...
	public EXTERN(): TerminalNode { return this.getToken(P4grammarParser.EXTERN, 0); }
	public nonTypeName(): NonTypeNameContext | undefined {
		return this.tryGetRuleContext(0, NonTypeNameContext);
	}
...
export class TupleTypeContext extends ParserRuleContext {
	public TUPLE(): TerminalNode { return this.getToken(P4grammarParser.TUPLE, 0); }
	public L_ANGLE(): TerminalNode { return this.getToken(P4grammarParser.L_ANGLE, 0); }
	public typeArgumentList(): TypeArgumentListContext {
...
export class HeaderStackTypeContext extends ParserRuleContext {
	...
	public L_BRACKET(): TerminalNode { return this.getToken(P4grammarParser.L_BRACKET, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
	public R_BRACKET(): TerminalNode { return this.getToken(P4grammarParser.R_BRACKET, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
...
export class HeaderTypeDeclarationContext extends ParserRuleContext {
	...
	public HEADER(): TerminalNode { return this.getToken(P4grammarParser.HEADER, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class StructTypeDeclarationContext extends ParserRuleContext {
	...
	public STRUCT(): TerminalNode { return this.getToken(P4grammarParser.STRUCT, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class HeaderUnionDeclarationContext extends ParserRuleContext {
	...
	public HEADER_UNION(): TerminalNode { return this.getToken(P4grammarParser.HEADER_UNION, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class EnumDeclarationContext extends ParserRuleContext {
	...
	public ENUM(): TerminalNode { return this.getToken(P4grammarParser.ENUM, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class ErrorDeclarationContext extends ParserRuleContext {
	public ERROR(): TerminalNode { return this.getToken(P4grammarParser.ERROR, 0); }
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
	public identifierList(): IdentifierListContext {
...
export class MatchKindDeclarationContext extends ParserRuleContext {
	public MATCH_KIND(): TerminalNode { return this.getToken(P4grammarParser.MATCH_KIND, 0); }
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
	public identifierList(): IdentifierListContext {
		return this.getRuleContext(0, IdentifierListContext);
	}
...
export class ExitStatementContext extends ParserRuleContext {
	public EXIT(): TerminalNode { return this.getToken(P4grammarParser.EXIT, 0); }
	public SEMICOLON(): TerminalNode { return this.getToken(P4grammarParser.SEMICOLON, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
...
export class ReturnStatementContext extends ParserRuleContext {
	public RETURN(): TerminalNode { return this.getToken(P4grammarParser.RETURN, 0); }
	public SEMICOLON(): TerminalNode { return this.getToken(P4grammarParser.SEMICOLON, 0); }
	public expression(): ExpressionContext | undefined {
		return this.tryGetRuleContext(0, ExpressionContext);
	}
...
export class ConditionalStatementContext extends ParserRuleContext {
	public IF(): TerminalNode { return this.getToken(P4grammarParser.IF, 0); }
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
...
export class SwitchStatementContext extends ParserRuleContext {
	public SWITCH(): TerminalNode { return this.getToken(P4grammarParser.SWITCH, 0); }
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
...
export class TableDeclarationContext extends ParserRuleContext {
	...
	public TABLE(): TerminalNode { return this.getToken(P4grammarParser.TABLE, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_BRACE(): TerminalNode { return this.getToken(P4grammarParser.L_BRACE, 0); }
...
export class ActionDeclarationContext extends ParserRuleContext {
	...
	public ACTION(): TerminalNode { return this.getToken(P4grammarParser.ACTION, 0); }
	public name(): NameContext {
		return this.getRuleContext(0, NameContext);
	}
	public L_PAREN(): TerminalNode { return this.getToken(P4grammarParser.L_PAREN, 0); }
...
export class ConstantDeclarationContext extends ParserRuleContext {
	...
	public CONST(): TerminalNode { return this.getToken(P4grammarParser.CONST, 0); }
	public typeRef(): TypeRefContext {
		return this.getRuleContext(0, TypeRefContext);
	}
	public name(): NameContext {
...
export class ExpressionContext extends ParserRuleContext {
	...
	public R_ANGLE(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(P4grammarParser.R_ANGLE);
		} else {
			return this.getToken(P4grammarParser.R_ANGLE, i);
		}
	}
	public LE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.LE, 0); }
	public GE(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.GE, 0); }
...
export class Type_or_idContext extends ParserRuleContext {
	public IDENTIFIER(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.IDENTIFIER, 0); }
	public TYPE_IDENTIFIER(): TerminalNode | undefined { return this.tryGetToken(P4grammarParser.TYPE_IDENTIFIER, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
